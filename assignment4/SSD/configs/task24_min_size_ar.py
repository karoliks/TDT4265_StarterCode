...
anchors.aspect_ratios=[[0.28,0.32], [0.32, 0.68], [0.68, 0.85], [0.84, 1.1], [1.1,2], [2,3]]
# [persopn, (rider scooter)], [bicycle], [bus,], [truck], [car]

# anchors.feature_sizes=[[32, 256], [16, 128], [8, 64], [4, 32], [2, 16], [1, 8]]

# anchors.strides=[[4, 4], [8, 8], [16, 16], [32, 32], [64, 64], [128, 128]]

anchors.min_sizes= [[8, 8], [14, 14], [45, 45], [56, 56], [26, 26], [128, 128], [128, 400]] # test for  humans?
# anchors.min_sizes= [[8, 8], [32, 32], [48, 48], [64, 64], [86, 86], [128, 128], [128, 400]] # test for  humans?
